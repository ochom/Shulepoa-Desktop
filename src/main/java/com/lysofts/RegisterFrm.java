...
public class RegisterFrm extends javax.swing.JFrame {
    ...
    String schoolName, email, name, phone, password;
    ...
    private void register() {
        ...
        if (isEmpty(schoolName) || isEmpty(name) || isEmpty(email) || isEmpty(phone) || isEmpty(password)) {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if (UserDAO.get().size() > 0) {
            JOptionPane.showMessageDialog(this, "Use a registered account to login");
        } else {
            register();
        }
